...
* _Training data_ (level-zero data) $O_i=(X_i,Y_i)$ of $N$ i.i.d observations.
...
_I look forward to a world without hyperparameters._ (Berent Å.S. Lunde)
...
Hyperparametertuning is performed using a separate validation set or by cross-validation. Different loss functions or selection criteria may be used (MSE, AUC, misclassification rate, ...).
...
There exist many ways to _group_ methods for hyperparameter tuning. One way to look at this is (Kuhn and Silge, 2021, Ch 12)
